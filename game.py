    ...
    def render(self): #i love the saxophone in this goofy punk rock french song https://www.youtube.com/watch?v=zreo9Y3EieA
        ...
        if not self.playing:
            ...
            if self.credits:
                ...
                # pr.draw_text('''Minigame Developement:
                # \n\tMilo Cummings (Milo-C-6), Lincoln Dabb (LincolnDabb3)''',130,100,28,pr.WHITE)
                # pr.draw_text("Main Menu, Transition Code:",130,160,28,pr.WHITE)
                # pr.draw_text("Milo Cummings",150,190,28,pr.WHITE)
